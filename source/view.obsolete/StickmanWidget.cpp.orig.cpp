...
/*
float SHOULDER_WIDTH   = 0.4f;
float TORSO_HEIGHT  = 0.6f;
float TORSO_RADIUS_TOP = 0.1f;
float TORSO_RADIUS_BOT = 0.065f;
float HIP_WIDTH        = 0.20f;
float LEG_LENGTH = 1.2f;
float UARM_LENGTH = 0.31f;
float LARM_LENGTH = 0.31f;
float UARM_RADIUS_TOP = 0.04f;
float UARM_RADIUS_BOT = 0.03f;
float LARM_RADIUS_TOP = 0.03f;
float LARM_RADIUS_BOT = 0.02f;
float SHOULDER_RADIUS = 0.065f;
float SKULL_RADIUS = 0.22f;
float EYE_RADIUS = 0.05f;
float PUPIL_RADIUS = 0.02f;
#define NUM_POLY  12

*/


StickmanWidget::StickmanWidget(QWidget *parent) : QGLWidget(parent)
{
   //printf("Stickmanwidget\n");
...
void StickmanWidget::SetTitle(std::string &t)
{

}

void StickmanWidget::SetSampleOffset(int value)
{
   sampleoffset=value;
}

void StickmanWidget::SetData(DataBase *data)
{
   DataStickman *data2 = dynamic_cast<DataStickman *>(data);
   assert(data2);

   StickmanWidget::data = *data2;
}

void StickmanWidget::Plot()
{
...
******************************************************************************/
void StickmanWidget::setJoints(std::vector<float> _torsorot,std::vector<float> _luarot,std::vector<float> _llarot,std::vector<float> _ruarot,std::vector<float> _rlarot)
{
   torsorot=_torsorot;
   luarot=_luarot;
   llarot=_llarot;
...
/******************************************************************************
  StickmanWidget::setJointsQ
*******************************************************************************
   Set the joint of the stick man.

   Same as setJoints, but with quaternions.
******************************************************************************/
void StickmanWidget::setJointsQ(std::vector<float> _torsorot,std::vector<float> _luarot,std::vector<float> _llarot,std::vector<float> _ruarot,std::vector<float> _rlarot)
{
   float a;
...
/******************************************************************************
  StickmanWidget::convertXsense2Stickman
*******************************************************************************
...
******************************************************************************/
void StickmanWidget::convertXsense2Stickman(std::vector<float> _torsorot,std::vector<float> _luarot,std::vector<float> _llarot,std::vector<float> _ruarot,std::vector<float> _rlarot,
...
void StickmanWidget::resizeGL(int w, int h)
{
...
void StickmanWidget::setColor(float r,float g,float b)
{
   //glColor4f(r,g,b,1.0);
...
/******************************************************************************
   StickmanWidget::createDisplayList
*******************************************************************************
...
******************************************************************************/
void StickmanWidget::createDisplayList()
{
   //printf("StickmanWidget::createDisplayList\n");
...
******************************************************************************/
void StickmanWidget::drawStickman()
{
...
QImage *StickmanWidget::GetImage()
{
...
*******************************************************************************
******************************************************************************/
void StickmanWidget::mouseMoveEvent ( QMouseEvent * event )
{
    emit mouseMoved(0);
    event->accept();
}

void StickmanWidget::mousePressEvent ( QMouseEvent * event )
{
