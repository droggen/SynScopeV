...
#ifndef PHONON_UI_SEEKSLIDERP_H
#define PHONON_UI_SEEKSLIDERP_H
 ...
 */
class PHONON_EXPORT SeekSliderP : public QWidget
{
    Q_OBJECT
    K_DECLARE_PRIVATE(SeekSliderP)
    /**
    ...
    public:
         ...
         */
        explicit SeekSliderP(QWidget *parent = 0);
        explicit SeekSliderP(MediaObject *media, QWidget *parent = 0);
    ...
    protected:
        SeekSliderPPrivate *const k_ptr;
